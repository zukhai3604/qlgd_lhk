...
abstract class $AuthUserDtoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String email, String displayName, String role});
}
...
class _$AuthUserDtoImpl implements _AuthUserDto {
  ...
  @override
  String toString() {
    return 'AuthUserDto(id: $id, email: $email, displayName: $displayName, role: $role)';
  }
...
abstract class _AuthUserDto implements AuthUserDto {
  const factory _AuthUserDto(
      ...
      required final String role}) = _$AuthUserDtoImpl;
