...
import 'package:qlgd_lhk/features/lecturer/schedule/presentation/view_model/weekly_schedule_view_model.dart';
...
class _WeeklySchedulePageState extends ConsumerState<WeeklySchedulePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final viewModel = ref.read(weeklyScheduleViewModelProvider.notifier);

    // Sync state với ViewModel
    if (state.data != null) {
      final data = state.data!;
      final incomingSemester = data.selectedSemesterId ??
          (data.semesters.isNotEmpty ? data.semesters.first.value : null);
      final incomingWeek = data.selectedWeekValue ??
          (data.weeks.isNotEmpty ? data.weeks.first.value : null);
