...
class MakeupHistoryPage extends ConsumerWidget {
                  ...
                  : ListView.builder(
                      ...
                      itemCount: state.filteredItems.length,
                                      itemBuilder: (context, i) {
                                        ...
                                        return _buildMakeupCard(context, item, state.originalItems, viewModel);
                                      },
                                    ),
                            ),
                          ],
  ...
  Widget _buildMakeupCard(
    ...
    final hasTime = timeRange.isNotEmpty && timeRange != '--:-- - --:--';

    // Status info
    final statusStr = (item['status'] ?? item['_normalized_status'] ?? 'PENDING').toString();
    ...
    return Card(
      ...
      child: InkWell(
        ...
        children: [
              ...
              // ===== BÊN PHẢI: Trạng thái + thời gian + hint/button =====
              SizedBox(
                height: 80,
                child: Column(
